namespace ContentDotNet.Extensions.Video.H264.Components.IO.Cavlc
{
    using ContentDotNet.BitStream;

    // NOTE: We might potentially move to using vlcgen for the Variable Length Codes
    // for precision and maintainability. The trade-off? Large assembly sizes.

    internal static class H264CavlcCommon
    {
