    ...
    internal class DefaultRbspReader : IH264IOReader
    {
        ...
        public RbspMbPred ReadMbPred(IH264SyntaxReader syntaxReader, H264RbspState rbspState)
        {
            ...
            else if (mbpp != Direct)
            {
                ...
                if (variables != null)
                    variables.ListType = H264ListType.List0;
                ...
                if (variables != null)
                    variables.ListType = H264ListType.List1;
        ...
        public RbspResidual ReadResidual(IH264SyntaxReader syntaxReader, H264MacroblockInfo mb, H264RbspState rbspState) => ResidualIO.ReadResidual(syntaxReader, mb, rbspState);
        ...
        internal static H264DecodingVariables? GetDecodingVariables(IH264SyntaxReader reader)
        {
