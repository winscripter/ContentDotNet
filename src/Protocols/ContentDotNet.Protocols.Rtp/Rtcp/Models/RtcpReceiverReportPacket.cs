...
{
    /// <summary>
    ///   A receiver report RTCP packet.
    /// </summary>
    public record RtcpReceiverReportPacket : IRtcpPacket
    {
        /// <summary>
        ///   The version
        /// </summary>
        ...
        public RtcpReceiverReportPacket(uint version, bool padding, uint receptionReportCount, uint packetType, uint length, uint ssrc, uint ssrcN, uint fractionLost, uint cumulativeNumberOfPacketsLost, uint extendedHighestSequenceNumberReceived, uint interarrivalJitter, uint lastSRTimestamp, uint delaySinceLastSR)
        {
            Version = version;
            Padding = padding;
