...
/// <summary>
///   A container for 64 <see cref="uint"/>s.
/// </summary>
public struct Container64UInt32 : IEquatable<Container64UInt32>
{
    ...
    {
        return obj is Container64UInt32 @int && Equals(@int);
    }

    public readonly bool Equals(Container64UInt32 other)
    {
        return _0 == other._0 &&
               _1 == other._1 &&
               _2 == other._2 &&
    ...
    public static bool operator ==(Container64UInt32 left, Container64UInt32 right)
    {
