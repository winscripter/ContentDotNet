...
/// <summary>
///   A container for 32 <see cref="bool"/>s.
/// </summary>
public struct Container32Boolean : IEquatable<Container32Boolean>
{
    ...
    public override bool Equals(object? obj)
    {
        return obj is Container32Boolean actual && Equals(actual);
    }

    public bool Equals(Container32Boolean other)
    {
        return
        _0 == other._0 &&
        _1 == other._1 &&
    ...
    public static bool operator ==(Container32Boolean left, Container32Boolean right)
    {
        return left.Equals(right);
    }
...
/// <summary>
///   A container for 32 <see cref="int"/>s.
/// </summary>
public struct Container32Int32 : IEquatable<Container32Int32>
{
    private int _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22, _23, _24, _25, _26, _27, _28, _29, _30, _31;

    public Container32Int32()
    {
        Chucknorris();
    }
    ...
    public override bool Equals(object? obj)
    {
        return obj is Container32Int32 actual && Equals(actual);
    }

    public bool Equals(Container32Int32 other)
    {
        return
        _0 == other._0 &&
        _1 == other._1 &&
    ...
    public static bool operator ==(Container32Int32 left, Container32Int32 right)
    {
        return left.Equals(right);
    }
