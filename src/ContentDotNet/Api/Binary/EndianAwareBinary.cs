namespace ContentDotNet.Api.Binary
{
    ...
    public class EndianAwareBinaryReader : BinaryReader
    {
        ...
        /// <param name="endianness">The endianness to use when reading data.</param>
        /// <param name="encoding">The character encoding (optional, defaults to UTF8).</param>
        /// <param name="leaveOpen">When false, the inner stream will be disposed when this binary reader is disposed.</param>
        public EndianAwareBinaryReader(Stream input, Endianness endianness, Encoding? encoding = null, bool leaveOpen = false)
            : base(input, encoding ?? Encoding.UTF8, leaveOpen: leaveOpen)
        {
            _endianness = endianness;
        }
    ...
    public class EndianAwareBinaryWriter : BinaryWriter
    {
        ...
        /// <param name="endianness">The endianness to use when writing data.</param>
        /// <param name="encoding">The character encoding (optional, defaults to UTF8).</param>
        /// <param name="leaveOpen">When false, the inner stream will be dispoesd when this binary writer is disposed.</param>
        public EndianAwareBinaryWriter(Stream output, Endianness endianness, Encoding? encoding = null, bool leaveOpen = false)
            : base(output, encoding ?? Encoding.UTF8, leaveOpen: leaveOpen)
        {
            _endianness = endianness;
        }
