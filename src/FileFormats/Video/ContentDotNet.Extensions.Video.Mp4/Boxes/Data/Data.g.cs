...
namespace ContentDotNet.Extensions.Video.Mp4.Boxes.Data.Utilities
{
	...
	public static class BuiltInNameToBoxFactory
	{
		...
		{
			["rssr"] = () => new Mp4ReceivedSsrcBoxData(),
			["tssy"] = () => new Mp4TimestampSynchronizationBoxData(),
			["tims"] = () => new Mp4TimescaleEntryBoxData(),
			["tsro"] = () => new Mp4TimeOffsetBoxData(),
			["snro"] = () => new Mp4SequenceOffsetBoxData(),
			["trpy"] = () => new Mp4TotalBytesSentIncluding12ByteRtpHeadersBoxData(),
			["nump"] = () => new Mp4TotalPacketsSentBoxData(),
			["tpyl"] = () => new Mp4TotalBytesSentNotIncludingRtpHeadersBoxData(),
			["totl"] = () => new Mp4TotalBytesSentIncluding12ByteRtpHeaders32BoxData(),
			["npck"] = () => new Mp4TotalPacketsSent32BoxData(),
			["tpay"] = () => new Mp4TotalBytesSentNotIncludingRtpHeaders32BoxData(),
			["maxr"] = () => new Mp4MaximumDataRateBoxData(),
			["dmed"] = () => new Mp4TotalBytesSentFromMediaTracksBoxData(),
			["dimm"] = () => new Mp4TotalBytesSentImmediateModeBoxData(),
			["drep"] = () => new Mp4TotalBytesInRepeatedPacketsBoxData(),
			["tmin"] = () => new Mp4SmallestRelativeTransmittionTimeMillisecondsBoxData(),
			["tmax"] = () => new Mp4LargestRelativeTransmittionTimeMillisecondsBoxData(),
			["pmax"] = () => new Mp4LargestPacketSentIncludingRtpHeaderBoxData(),
			["dmax"] = () => new Mp4LongestPacketDurationInMillisecondsBoxData(),
			["payt"] = () => new Mp4PayloadIdUsedInRtpPacketsBoxData(),
			["stvi"] = () => new Mp4StereoVideoInfoBoxData(),
			["elng"] = () => new Mp4ExtendedLanguageBoxData(),
			["btrt"] = () => new Mp4BitRateInformationBoxData(),
			["pasp"] = () => new Mp4PixelAspectRatioBoxData(),
			["clap"] = () => new Mp4CleanApertureBoxData(),
			["cclv"] = () => new Mp4ContentColourVolumeBoxData(),
			["colr"] = () => new Mp4ColorInformationBoxData(),
			["clli"] = () => new Mp4ContentLightLevelBoxData(),
			["mdcv"] = () => new Mp4MasteringDisplayColourVolumeBoxData(),
			["scrb"] = () => new Mp4ScrambleSchemeInfoBoxData(),
			["srat"] = () => new Mp4SamplingRateBoxData(),
			["txtC"] = () => new Mp4TextStreamConfigurationBoxData(),
			["uriI"] = () => new Mp4UriInformationBoxData(),
			["cprt"] = () => new Mp4CopyrightBoxData(),
			["kind"] = () => new Mp4TrackKindBoxData(),
			["tsel"] = () => new Mp4TrackSelectionBoxData(),
			["strk"] = () => new Mp4SubTrackBoxData(),
			["hnti"] = () => new Mp4HintInformationBoxData(),
			["sdp "] = () => new Mp4SdpInformationBoxData(),
			["rtp "] = () => new Mp4RtpInformationBoxData(),
			["hinf"] = () => new Mp4HintStatisticsBoxData(),
			["url "] = () => new Mp4UrlBoxData(),
			["urn "] = () => new Mp4UrnBoxData(),
			["imdt"] = () => new Mp4IdentifiedMediaDataImdtBoxData(),
			["snim"] = () => new Mp4SequenceNumberIdentifiedMediaDataBoxData(),
			["ipco"] = () => new Mp4ItemPropertyContainerBoxData(),
			["ipma"] = () => new Mp4ItemPropertyAssociationBoxData(),
			["iprp"] = () => new Mp4ItemPropertiesBoxData(),
			["assp"] = () => new Mp4ActiveSequenceStartupPropertiesBoxData(),
			["bxml"] = () => new Mp4BinaryXmlBoxData(),
			["cinf"] = () => new Mp4CompleteTrackInformationBoxData(),
			["co64"] = () => new Mp4ChunkLargeOffsetBoxData(),
			["cslg"] = () => new Mp4CompositionToDecodeTimelineMappingBoxData(),
			["ctts"] = () => new Mp4CompositionTimeToSampleBoxData(),
			["dinf"] = () => new Mp4DataInformationBoxData(),
			["dref"] = () => new Mp4DataReferenceBoxData(),
			["edts"] = () => new Mp4EditListContainerBoxData(),
			["elst"] = () => new Mp4EditListBoxData(),
			["etyp"] = () => new Mp4ExtendedTypeBoxData(),
			["fdel"] = () => new Mp4FileDeliveryInformationBoxData(),
			["fecr"] = () => new Mp4FecReservoirBoxData(),
			["free"] = () => new Mp4FreeSpaceBoxData(),
			["gitn"] = () => new Mp4GroupIdToNameBoxData(),
			["grpl"] = () => new Mp4GroupsListBoxData(),
			["hdlr"] = () => new Mp4HandlerBoxData(),
			["hmhd"] = () => new Mp4HintMediaHeaderBoxData(),
			["idat"] = () => new Mp4ItemDataBoxData(),
			["iinf"] = () => new Mp4ItemInformationBoxData(),
			["imda"] = () => new Mp4IdentifiedMediaDataImdaBoxData(),
			["ipro"] = () => new Mp4ItemProtectionBoxData(),
			["iref"] = () => new Mp4ItemReferenceBoxData(),
			["mdat"] = () => new Mp4MediaDataBoxData(),
			["mdhd"] = () => new Mp4MediaHeaderBoxData(),
			["mdia"] = () => new Mp4MediaBoxData(),
			["mehd"] = () => new Mp4MovieExtendsHeaderBoxData(),
			["meta"] = () => new Mp4MetaBoxBoxData(),
			["mfhd"] = () => new Mp4MovieFragmentHeaderBoxData(),
			["mfra"] = () => new Mp4MovieFragmentRandomAccessBoxData(),
			["mfro"] = () => new Mp4MovieFragmentRandomAccessOffsetBoxData(),
			["minf"] = () => new Mp4MediaInformationBoxData(),
			["moof"] = () => new Mp4MovieFragmentBoxData(),
			["moov"] = () => new Mp4MovieBoxData(),
			["mvex"] = () => new Mp4MovieExtendsBoxData(),
			["mvhd"] = () => new Mp4MovieHeaderBoxData(),
			["nmhd"] = () => new Mp4NullMediaHeaderBoxData(),
			["otyp"] = () => new Mp4OriginalFileTypeBoxBoxData(),
			["padb"] = () => new Mp4SamplePaddingBitsBoxData(),
			["pdin"] = () => new Mp4ProgressiveDownloadInformationBoxData(),
			["pitm"] = () => new Mp4PrimaryItemReferenceBoxData(),
			["prft"] = () => new Mp4ProducerReferenceTimeBoxData(),
			["rinf"] = () => new Mp4RestrictedSchemeInformationBoxData(),
			["saio"] = () => new Mp4SampleAuxiliaryInformationOffsetsBoxData(),
			["saiz"] = () => new Mp4SampleAuxiliaryInformationSizeBoxData(),
			["sbgp"] = () => new Mp4SampleToGroupBoxData(),
			["schi"] = () => new Mp4SchemeInformationBoxData(),
			["schm"] = () => new Mp4SchemeTypeBoxData(),
			["csch"] = () => new Mp4CompatibleSchemeTypeBoxData(),
			["sdtp"] = () => new Mp4SampleDependencyTypeBoxData(),
			["sidx"] = () => new Mp4SegmentIndexBoxData(),
			["skip"] = () => new Mp4FreeSpaceSkipBoxData(),
			["smhd"] = () => new Mp4SoundMediaHeaderBoxData(),
			["srpp"] = () => new Mp4StrpProcessBoxData(),
			["ssix"] = () => new Mp4SubsampleIndexBoxData(),
			["stbl"] = () => new Mp4SampleTableBoxData(),
			["stco"] = () => new Mp4ChunkOffsetBoxData(),
			["stdp"] = () => new Mp4SampleDegradationPriorityBoxData(),
			["sthd"] = () => new Mp4SubtitleMediaHeaderBoxData(),
			["strd"] = () => new Mp4SubTrackDefinitionBoxBoxData(),
			["stri"] = () => new Mp4SubTrackInformationBoxData(),
			["stsc"] = () => new Mp4SampleToChunkBoxData(),
			["stsd"] = () => new Mp4SampleDescriptionBoxData(),
			["stsg"] = () => new Mp4SubtrackSampleGroupingBoxData(),
			["stsh"] = () => new Mp4ShadowSyncSampleTableBoxData(),
			["stss"] = () => new Mp4SyncSampleTableBoxData(),
			["stsz"] = () => new Mp4SampleSizeBoxData(),
			["stts"] = () => new Mp4TimeToSampleBoxData(),
			["tfdt"] = () => new Mp4TrackFrameDecodeTimeBoxData(),
			["tkhd"] = () => new Mp4TrackHeaderBoxData(),
			["traf"] = () => new Mp4TrackFragmentBoxData(),
			["trak"] = () => new Mp4TrackBoxData(),
			["tref"] = () => new Mp4TrackReferenceContainerBoxData(),
			["trep"] = () => new Mp4TrackExtensionPropertiesBoxData(),
			["trex"] = () => new Mp4TrackExtendsBoxData(),
			["trgr"] = () => new Mp4TrackGroupingInformationBoxData(),
			["tyco"] = () => new Mp4TypeAndCombinationBoxData(),
			["udta"] = () => new Mp4UserDataBoxData(),
			["vmhd"] = () => new Mp4VideoMediaHeaderBoxData(),
			["xml "] = () => new Mp4XmlContainerBoxData(),
			["uri "] = () => new Mp4UriBoxData(),
		};
	}
}
