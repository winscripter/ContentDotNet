...
namespace ContentDotNet.Extensions.Image.Bmp.Headers
{
    ...
    /// </summary>
    public struct BitmapCoreHeader : IEquatable<BitmapCoreHeader?>
    {
        /// <summary>
        ///   The field BcSize
        /// </summary>
        ...
        /// </summary>
        /// <param name="BcSize">The parameter</param>
        ...
        public BitmapCoreHeader(DWORD BcSize, WORD BcWidth, WORD BcHeight, WORD BcPlanes, WORD BcBitCount)
        {
            this.BcSize = BcSize;
        ...
        {
            var BcSize = CommonBitmapIO.ReadDWORD(reader);
            ...
            return new BitmapCoreHeader(BcSize, BcWidth, BcHeight, BcPlanes, BcBitCount);
        }
        ...
        {
            var BcSize = await CommonBitmapIO.ReadDWORDAsync(reader);
        ...
        {
            CommonBitmapIO.WriteDWORD(writer, this.BcSize);
        ...
        {
            await CommonBitmapIO.WriteDWORDAsync(writer, this.BcSize);
        ...
        public readonly bool Equals(BitmapCoreHeader? other)
        {
            return other is not null
                && EqualityComparer<DWORD>.Default.Equals(other.Value.BcSize, this.BcSize)
        ...
        public override int GetHashCode()
        {
			...
			{
				int hash = 17;
				hash = hash * 23 + BcSize.GetHashCode();
    ...
    public struct BitmapInfoHeader : IEquatable<BitmapInfoHeader?>
    {
        ...
        /// </summary>
        /// <param name="BiSize">The parameter</param>
        ...
        public BitmapInfoHeader(DWORD BiSize, LONG BiWidth, LONG BiHeight, WORD BiPlanes, WORD BiBitCount, DWORD BiCompression, DWORD BiSizeImage, LONG BiXPelsPerMeter, LONG BiYPelsPerMeter, DWORD BiClrUsed, DWORD BiClrImportant)
        {
            this.BiSize = BiSize;
        ...
        {
            var BiSize = CommonBitmapIO.ReadDWORD(reader);
            ...
            return new BitmapInfoHeader(BiSize, BiWidth, BiHeight, BiPlanes, BiBitCount, BiCompression, BiSizeImage, BiXPelsPerMeter, BiYPelsPerMeter, BiClrUsed, BiClrImportant);
        }
        ...
        {
            var BiSize = await CommonBitmapIO.ReadDWORDAsync(reader);
        ...
        public readonly void Write(BinaryWriter writer)
        {
            CommonBitmapIO.WriteDWORD(writer, this.BiSize);
        ...
        public readonly async Task WriteAsync(BinaryWriter writer)
        {
            await CommonBitmapIO.WriteDWORDAsync(writer, this.BiSize);
        ...
        {
            return other is not null
                && EqualityComparer<DWORD>.Default.Equals(other.Value.BiSize, this.BiSize)
        ...
        public override int GetHashCode()
        {
			...
			{
				int hash = 17;
				hash = hash * 23 + BiSize.GetHashCode();
    ...
    public struct BitmapV4Header : IEquatable<BitmapV4Header?>
    {
        ...
        /// </summary>
        /// <param name="BV4Size">The parameter</param>
        ...
        {
            var BV4Size = CommonBitmapIO.ReadDWORD(reader);
            ...
            return new BitmapV4Header(BV4Size, BV4Width, BV4Height, BV4Planes, BV4BitCount, BV4V4Compression, BV4SizeImage, BV4XPelsPerMeter, BV4YPelsPerMeter, BV4ClrUsed, BV4ClrImportant, BV4RedMask, BV4GreenMask, BV4BlueMask, BV4AlphaMask, BV4CSType, BV4Endpoints, BV4GammaRed, BV4GammaGreen, BV4GammaBlue);
        }
        ...
        {
            var BV4Size = await CommonBitmapIO.ReadDWORDAsync(reader);
        ...
        public readonly void Write(BinaryWriter writer)
        {
            CommonBitmapIO.WriteDWORD(writer, this.BV4Size);
        ...
        public readonly async Task WriteAsync(BinaryWriter writer)
        {
            await CommonBitmapIO.WriteDWORDAsync(writer, this.BV4Size);
        ...
        {
            return other is not null
                && EqualityComparer<DWORD>.Default.Equals(other.Value.BV4Size, this.BV4Size)
        ...
        public override int GetHashCode()
        {
			...
			{
				int hash = 17;
				hash = hash * 23 + BV4Size.GetHashCode();
    ...
    public struct BitmapV5Header : IEquatable<BitmapV5Header?>
    {
        ...
        /// </summary>
        /// <param name="BV5Size">The parameter</param>
        ...
        {
            var BV5Size = CommonBitmapIO.ReadDWORD(reader);
            ...
            return new BitmapV5Header(BV5Size, BV5Width, BV5Height, BV5Planes, BV5BitCount, BV5Compression, BV5SizeImage, BV5XPelsPerMeter, BV5YPelsPerMeter, BV5ClrUsed, BV5ClrImportant, BV5RedMask, BV5GreenMask, BV5BlueMask, BV5AlphaMask, BV5CSType, BV5Endpoints, BV5GammaRed, BV5GammaGreen, BV5GammaBlue, BV5Intent, BV5ProfileData, BV5ProfileSize, BV5Reserved);
        }
        ...
        {
            var BV5Size = await CommonBitmapIO.ReadDWORDAsync(reader);
        ...
        public readonly void Write(BinaryWriter writer)
        {
            CommonBitmapIO.WriteDWORD(writer, this.BV5Size);
        ...
        public readonly async Task WriteAsync(BinaryWriter writer)
        {
            await CommonBitmapIO.WriteDWORDAsync(writer, this.BV5Size);
        ...
        {
            return other is not null
                && EqualityComparer<DWORD>.Default.Equals(other.Value.BV5Size, this.BV5Size)
        ...
        public override int GetHashCode()
        {
			...
			{
				int hash = 17;
				hash = hash * 23 + BV5Size.GetHashCode();
