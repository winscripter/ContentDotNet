namespace ContentDotNet.Video.Codecs.H264.Components
{
    ...
    public static partial class H264MacroblockTraits
    {
        ...
        private static int P_GetNumMbPart(int mbType)
        {
            // P_L0_16x16
            if (mbType == 0)
            {
        ...
        private static int P_MbPartPredMode_0(int mbType)
        {
            // P_L0_16x16
            if (mbType == 0)
            {
        ...
        private static int P_MbPartPredMode_1(int mbType)
            {
            // P_L0_16x16
            if (mbType == 0)
            {
        ...
        private static int P_MbPartWidth(int mbType)
        {
            // P_L0_16x16
            if (mbType == 0)
            {
        ...
        private static int P_MbPartHeight(int mbType)
        {
            // P_L0_16x16
            if (mbType == 0)
            {
        ...
        private static int? B_GetNumMbPart(int mbType)
        {
            // B_Direct_16x16
            if (mbType == 0)
            {
        ...
        private static int B_MbPartWidth(int mbType)
        {
            // B_Direct_16x16
            if (mbType == 0)
            {
        ...
        private static int B_MbPartHeight(int mbType)
        {
            // B_Direct_16x16
            if (mbType == 0)
            {
        ...
        private static int SubP_NumSubMbPart(int mbType)
        {
            // P_L0_8x8
            if (mbType == 0)
            {
        ...
        private static int SubP_SubMbPredMode(int mbType)
        {
            // P_L0_8x8
            if (mbType == 0)
            {
        ...
        private static int SubP_SubMbPartWidth(int mbType)
        {
            // P_L0_8x8
            if (mbType == 0)
            {
        ...
        private static int SubP_SubMbPartHeight(int mbType)
        {
            // P_L0_8x8
            if (mbType == 0)
            {
        ...
        private static int SubB_NumSubMbPart(int mbType)
        {
            // B_Direct_8x8
            if (mbType == 0)
            {
        ...
        private static int SubB_SubMbPredMode(int mbType)
        {
            // B_Direct_8x8
            if (mbType == 0)
            {
        ...
        private static int SubB_SubMbPartWidth(int mbType)
        {
            // B_Direct_8x8
            if (mbType == 0)
            {
        ...
        private static int SubB_SubMbPartHeight(int mbType)
        {
            // B_Direct_8x8
            if (mbType == 0)
            {
