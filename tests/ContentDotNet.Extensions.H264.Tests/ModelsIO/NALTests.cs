...
public class NALTests
{
    ...
    {
        var nalu = new NalUnit(nalRefIdc: 1u, nalUnitType: 6u, false, false, null, default);
    ...
    {
        var nalu = new NalUnit(nalRefIdc: 1u, nalUnitType: 6, false, false, null, default);
    ...
    {
        var nalu = new NalUnit(nalRefIdc: 1u, nalUnitType: 14, true, false, new SvcNalUnitHeaderExtension(true, 2, false, 3, 2, 3, true, false, true, 3), default);
    ...
    {
        var nalu = new NalUnit(nalRefIdc: 1u, nalUnitType: 20, false, false, new MvcNalUnitHeaderExtension(true, 2, 3, 2, false, true, true), default);
    ...
    {
        var nalu = new NalUnit(nalRefIdc: 1u, nalUnitType: 21, false, true, new Avc3DNalUnitHeaderExtension(2, false, true, 3, true, false), default);
